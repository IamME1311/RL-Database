...
export const authApi = {
  ...
  }: Ctx & { suppressUnauthorizedRedirect?: boolean } = {}): Promise<SessionUser> =>
    USE_MOCKS
      ? mockAuth.me(signal)
