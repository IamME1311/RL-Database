...
export const SCOPE_FILTER_KEYS: Record<string, string[]> = {
  ...
  campaigns: ['status', 'report_status', 'month', 'year', 'manager', 'brand', 'start_from', 'start_to'],
  pitches: [
    'p_org', 'requirement', 'p_platform', 'sales_lead', 'list_lead', 'company',
